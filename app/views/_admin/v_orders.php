                        ...
                        <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <?php foreach ($orders as $row ) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?=  $row->usr_fname ?>&nbsp;<?=  $row->usr_lname ?> <br>
                                        <?php if($row->usr_group == 3){ echo '<code>Retailer</code>'; }else{ echo '<code>Member</code>'; }?>
                                    </td>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-primary" href="<?=base_url('admin/admin_orders/order_details?order_id='.$row->id.'&item_name='.$row->items);?>" title="View"><i class="fa fa-search"></i> View Details</a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
