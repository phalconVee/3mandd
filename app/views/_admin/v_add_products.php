            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="<?=base_url('admin/admin_products/create');?>" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left" novalidate>

                            <p>All fields marked <code>asterisk*</code> is important.</p>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Unit <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <?php echo form_dropdown('unit_id', $drop_units, '', 'id="unit" class="form-control col-md-7 col-xs-12"');  ?>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="pro_name" class="form-control col-md-7 col-xs-12" data-validate-length-range="3" data-validate-words="1" placeholder="Enter Product Name (e.g. Maltina Can Cartoon)" required="required" type="text" value="<?= set_value('pro_name') ?>">
                                </div>
                            </div>
